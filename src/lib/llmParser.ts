...
3. 输出格式必须是严格的 JSON 数组，每个元素包含以下字段：
   ...
   - category: 赛事类别，必须是以下之一：
     * "ball"（球类）：篮球、足球、排球、乒乓球、羽毛球、网球、棒球、垒球、高尔夫球、台球、橄榄球等所有涉及"球"的运动
     * "track"（田径）：跑步、跳高、跳远、铅球、铁饼、标枪等
     * "water"（水上）：游泳、跳水、水球、龙舟、皮划艇、赛艇、帆船等
     * "other"（其他）：武术、跆拳道、体操、健美操、啦啦操、棋类、桥牌、电子竞技、定向越野、攀岩、自行车等不属球类/田径/水上的运动
